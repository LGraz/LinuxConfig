...
# python3 ~/LinuxConfig/installation-scripts/add_gnome_shortcut.py 'connect wh910' '~/.connect_wh910n.sh' '<Super>h'
...
# SHORTCUTS
# python3 ~/LinuxConfig/installation-scripts/add_gnome_shortcut.py 'open guake' 'guake' '<Super>e'

# remove 60 seconds timer
