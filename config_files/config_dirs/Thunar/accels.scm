...
(gtk_accel_path "<Actions>/ThunarWindow/toggle-image-preview" "<Primary><Alt>2")
...
(gtk_accel_path "<Actions>/ThunarWindow/view-location-selector-buttons" "<Primary><Alt>1")
...
; (gtk_accel_path "<Actions>/ThunarBookmarks/b0fd8263af8ce64adb30424fd083174f" "")
